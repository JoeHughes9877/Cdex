-- =========================================================================================
-- MASSIVE SEED DATA REMAKE (25 AUTHORS, 50+ BOOKS)
-- This script provides robust seed data for a large-scale interconnected schema test.
-- =========================================================================================

-- IMPORTANT: Lines for resetting the database during testing.
DELETE FROM quotes;
