...
def create_author(author: Author, session: SessionDep, api_key: APIKey = Depends(write_auth)) -> Author:
...
def update_author_item(
    ...
    api_key: APIKey = Depends(write_auth)
):
...
def delete_author(author_id: int, session: SessionDep, api_key: APIKey = Depends(write_auth)):
...
def create_world(world: World, session: SessionDep, api_key: APIKey = Depends(write_auth)) -> World:
...
def delete_world(world_id: int, session: SessionDep, api_key: APIKey = Depends(write_auth)):
...
def create_series(series: Series, session: SessionDep, api_key: APIKey = Depends(write_auth)) -> Series:
...
def create_character(character: Character, session: SessionDep, api_key: APIKey = Depends(write_auth)) -> Character:
...
def delete_character(character_id: int, session: SessionDep, api_key: APIKey = Depends(write_auth)):
...
def create_kingdom(kingdom: Kingdom, session: SessionDep, api_key: APIKey = Depends(write_auth)) -> Kingdom:
...
def delete_kingdom(kingdom_id: int, session: SessionDep, api_key: APIKey = Depends(write_auth)):
...
def create_book(book: Book, session: SessionDep, api_key: APIKey = Depends(write_auth)) -> Book:
...
def delete_book(book_id: int, session: SessionDep, api_key: APIKey = Depends(write_auth)):
...
def delete_quote(quote_id: int, session: SessionDep, api_key: APIKey = Depends(write_auth)):
...
'''-----api-key endpoints-----'''
@app.get("/api-generation-read/", tags=["Api-Key"])
def generate_read_key(session: SessionDep):
